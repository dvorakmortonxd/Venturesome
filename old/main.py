...
class MainWindow(QMainWindow):
    ...
    def add_new_tab(self, qurl=None, label="Blank"):
        ...
        # creating a QWebEngineView object with web profile
        profile = QWebEngineProfile.defaultProfile()
        browser = QWebEngineView(profile=profile)

        # setting url to browser
        browser.setUrl(qurl)

        # enable fullscreen support for YouTube videos
